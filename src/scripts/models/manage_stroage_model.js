...
export const getTempPreference = () => {
...
export const setTempPreference = (choice) => {
  localStorage.setItem("temp", choice);
};
...
export const checkForFavoritesOnLoad = () => {
  ...
  if (
    favorites.indexOf(favoriteName) == true ||
    favorites.indexOf(favoriteName) == 0
  )
    return true;
};
...
export const manageFavorites = () => {
  ...
  if (favorites.length >= 5)
    return alert("You cannot have more then 5 favorites!");
